      ...
      <div className="business-support-inner">
        <div className="business-support-title-block">
          ...
          <h2 className="business-support-title">
            Sviluppiamo <span className="blue">soluzioni digitali</span> su misura che semplificano i processi,
            integrano i sistemi e accelerano la crescita del tuo business.
          </h2>
          <p className="business-support-desc">
            In un mercato sempre più complesso, le aziende si trovano a gestire una moltitudine di strumenti diversi:
            marketing, gestione dati, vendite, post–vendita, logistica e molto altro.
          </p>
          <p className="business-support-desc highlight-line">
